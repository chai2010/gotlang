...
func TestParseFiles(t *testing.T) {
	...
	template := New("root")
	_, err = template.ParseFiles("testdata/file1.gotmpl", "testdata/file2.gotmpl")
	if err != nil {
...
func TestParseGlob(t *testing.T) {
	...
	template := New("root")
	_, err = template.ParseGlob("testdata/file*.gotmpl")
	if err != nil {
		t.Fatalf("error parsing files: %v", err)
	}
	testExecute(multiExecTests, template, t)
...
var templateFileExecTests = []execTest{
	{"test", `{{template "tmpl1.gotmpl"}}{{template "tmpl2.gotmpl"}}`, "template1\n\ny\ntemplate2\n\nx\n", 0, true},
}

func TestParseFilesWithData(t *testing.T) {
	template, err := New("root").ParseFiles("testdata/tmpl1.gotmpl", "testdata/tmpl2.gotmpl")
	if err != nil {
		t.Fatalf("error parsing files: %v", err)
	}
...
func TestParseGlobWithData(t *testing.T) {
	template, err := New("root").ParseGlob("testdata/tmpl*.gotmpl")
	if err != nil {
		t.Fatalf("error parsing files: %v", err)
	}
	testExecute(templateFileExecTests, template, t)
